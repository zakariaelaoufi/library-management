...
<body>
		...
		<form action="./etudiant/new" method="post"> <!-- Update form action -->
            <h1 class="text-3xl block text-center font-semibold">Ajouter un Etudiant</h1>
            <hr class="mt-3">
            <div class="mt-3">
            ...
            <div class="mt-3">
                <label for="CNE" class="block text-base mb-2">CNE</label>
                <input required type="text" name="CNE" id="CNE" class="border w-full text-base px-2 py-2 text-gray-900 rounded-lg focus:outline-none focus:ring-0 focus:border-green-600" placeholder="Enter CNE..." />
            </div>
            <div class="mt-3">
            ...
            <div class="mt-3">
                <label for="adresse" class="block text-base mb-2">Adresse</label>
           		<input required type="text" name="Adresse" id="adresse" class="border w-full text-base px-2 py-2 text-gray-900 rounded-lg focus:outline-none focus:ring-0 focus:border-green-600" placeholder="Enter Adresse..." />
            </div>
...
<script type="text/javascript">
    function confirmSubmitForm(form) {
        Swal.fire({
            text: "Voulez vous vraiment ajouté ce etudiant?",
            icon: "question",
