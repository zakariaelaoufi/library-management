...
<body>
	...
	<%	EnseignantOperation EnseignantDAO = new EnseignantOperation();  
		ArrayList<Enseignant> listEnseignant = EnseignantDAO.GetAllEnseignants();
	%>
    ...
    <table id="myTable" class="text-[15px] text-left text-gray-900 rounded-lg">
        ...
        <%for(Enseignant enseignant : listEnseignant) { %>
            <tr class="bg-emerald-100 border-b dark:border-white">
                ...
                <td>
				<a href="./ModifierEnseignant.jsp?CIN=<%=enseignant.getCIN()%>">
				...
				<a href="./enseignant/delete?CIN=<%=enseignant.getCIN()%>">
